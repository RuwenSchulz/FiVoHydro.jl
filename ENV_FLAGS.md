...
| `EX08_DIAG` | `""` | `examples2d/08_vorticity.jl:246` | examples2d/08_vorticity.jl |
| `EX08_FPS` | `"8"` | `examples2d/08_vorticity.jl:113` | examples2d/08_vorticity.jl |
| `EX08_N` | `"160"` | `examples2d/08_vorticity.jl:110` | examples2d/08_vorticity.jl |
| `EX08_NFRAME` | `"32"` | `examples2d/08_vorticity.jl:111` | examples2d/08_vorticity.jl |
| `EX08_NOFADE` | `""` | `examples2d/08_vorticity.jl:121` | examples2d/08_vorticity.jl |
| `EX08_SIZE` | `"560"` | `examples2d/08_vorticity.jl:112` | examples2d/08_vorticity.jl |
| `EX08_TAUF` | `"6.0"` | `examples2d/08_vorticity.jl:115` | examples2d/08_vorticity.jl |
| `EX10_FPS` | `"12"` | `examples2d/10_showcase.jl:78` | examples2d/10_showcase.jl |
| `EX10_N` | `"240"` | `examples2d/10_showcase.jl:75` | examples2d/10_showcase.jl |
| `EX10_NFRAME` | `"48"` | `examples2d/10_showcase.jl:76` | examples2d/10_showcase.jl |
| `EX10_SIZE` | `"640"` | `examples2d/10_showcase.jl:77` | examples2d/10_showcase.jl |
| `EX10_TAUF` | `"8.0"` | `examples2d/10_showcase.jl:79` | examples2d/10_showcase.jl |
...
| `FIVO_AXIS_CELL_EXACT` | `"1"` | `src/runtime_flags.jl:128` | src/runtime_flags.jl |
...
170 distinct flags across 134 files — generated by `tools/list_env_flags.jl`.
